	...
	<div id="mainmenu">
		<?php
			...
			array('items'=>array(
				...
				array('label'=>'Учительская', 'url'=>array('/teacher'), 'visible' => $role == Persons::PERSON_TEACHER || $role == Persons::PERSON_ADMIN),
				array('label'=>'Администрирование', 'url'=>array('/admin'), 'visible' => $role == Persons::PERSON_ADMIN),
